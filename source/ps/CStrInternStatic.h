...
X(a_tangent)
X(a_waterInfo)
X(a_instancingTransform0)
X(a_instancingTransform1)
X(a_instancingTransform2)
X(a_instancingTransform3)
X(ambient)
X(baseTex)
X(blendTex)
X(bloom)
...
X2(instancingTransforms, "instancingTransforms[0]")
X(losMap)
X(losMatrix)
X(losTex)
X(losTex1)
